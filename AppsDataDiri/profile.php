...
<div class="alert alert-danger alert-dismissable"><h3>Identifikasi Forensik Tangan</h3></div>
			<table class="table table-striped">
				<tr>
			...
			<div class="callout callout-success"><h3>Identifikasi Forensik Kaki</h3></div>
			<table class="table table-striped">
				<tr>
...
<div class="callout callout-info"><h3>Identifikasi Ciri Umum</h3></div>
			<table class="table table-striped">
				<tr>
