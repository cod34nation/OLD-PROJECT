...
<?php 
$hasil2 = mysqli_query($koneksi, "SELECT * FROM donasi,status WHERE donasi.id_status=status.id_status AND donasi.id_user = '$iduse' GROUP BY id_donasi DESC " );
                                   ...
                                   <td>'.$atas_nam.'</td>
                                    <td>'.$tanggl.'</td>
                                     <td>'.$dana.'</td>
                                      <td>'.$idref.'</td>
                                      <td>'.$statu.'</td>
                                      <td>';if ($data2['id_status']==3) {
          echo '<a href="geolocation-direction.php?id='.$data2['id_pengajuan'].'" title="Rubah Data"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>CEK LOKASI   </a>';
          }else{
          echo "Menunggu ...   ";
              }'</td>
                                  </tr>';                           }
