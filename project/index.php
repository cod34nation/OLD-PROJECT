  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <span class="logo-mini"><b>PT</b>AFF</span>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">UMKM</span>
              </a>
    ...
    <footer class="main-footer">
      ...
      <strong> <?php echo"aaaa". $_SESSION['identitas'];?>Copyright &copy; 2014-2015 <a href="http://almsaeedstudio.com">Almsaeed Studio</a>.</strong> All rights reserved.
    </footer>
