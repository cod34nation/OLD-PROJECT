	...
	<div class="container">
		<div class="content">
			...
			<table class="table table-striped table-hover">
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM donasi  GROUP BY kode_ref DESC ");
				...
				<td>';
					if($row['id_status'] == 1){
					echo '<span class="label label-danger">Belum Transfer 
					</span>';
					}else{
       				echo '<span class="label label-success">Donasi Tersalurkan</span>';
							}
					echo '
							</td>
