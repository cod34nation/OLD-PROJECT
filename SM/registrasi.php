...
//				
				...
				if(mysqli_num_rows($cek) == 0){
					if($pass1 == $pass2){
						...
						$insert = mysqli_query($koneksi, "INSERT INTO login(id_user, password, nama_umkm, nama_pemilik, alamat,jenis_usaha,id_usaha)
															VALUES('$id_user', '$pass', '$nama_umkm', '$nama_pemilik', '$alamat','$jenis_usaha', '$id_usaha')") or die(mysqli_error());
						}
						
						else if($id_usaha=='2')
						{$jenis_usaha="DAGANG BARANG";
						$insert = mysqli_query($koneksi, "INSERT INTO login(id_user, password, nama_umkm, nama_pemilik, alamat,jenis_usaha,id_usaha)
															VALUES('$id_user', '$pass', '$nama_umkm', '$nama_pemilik', '$alamat','$jenis_usaha', '$id_usaha')") or die(mysqli_error());
						}
						
						else if($id_usaha=='3')
						{$jenis_usaha="DAGANG MAKANAN";
						$insert = mysqli_query($koneksi, "INSERT INTO login(id_user, password, nama_umkm, nama_pemilik, alamat,jenis_usaha,id_usaha)
															VALUES('$id_user', '$pass', '$nama_umkm', '$nama_pemilik', '$alamat','$jenis_usaha', '$id_usaha')") or die(mysqli_error());
						}
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="id_usaha" class="form-control">
							...
							<option value="5">BARANG ELEKTRONIK</option>
