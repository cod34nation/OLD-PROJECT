...
<div id="wrapper">
	...
	<div class="slider-wrapper futurico-theme">
		...
		<div id="slider" class="nivoSlider">
			...
			<img src="img/andi.png" alt="" title="#caption1">

			<img src="img/adnan.png" alt="" title="#caption2">

			<img src="img/gita.png" alt="" title="#caption3">

			<img src="img/miranti.png" alt="" title="#caption4">

		</div>

		<div id="caption1" class="nivo-html-caption">
			<strong>Andi Ramdani</strong> <span></span> <em>0901790</em>.
		</div>
		<div id="caption2" class="nivo-html-caption">
			<strong>Adnan Fahmi</strong> <span></span> <em>0906353</em>.
		</div>

		<div id="caption3" class="nivo-html-caption">
			<strong>Gita Permata</strong> <span></span> <em>0904034</em>.
		</div>
		<div id="caption4" class="nivo-html-caption">
			<strong>Miranti Oktaviani</strong> <span></span> <em>0900683</em>.
		</div>
