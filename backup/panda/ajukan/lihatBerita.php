...
?>
	<div class="row-fluid">
      ...
      <div class="span8">
          ...
          <p style="text-align:justify;"><?=substr($hasil_data['keterangan'],0,500);?></p>
          <p>
          	<a href="index.php?link=lihatDetailBerita.php&id=<?=$hasil_data['id_pengajuan'];?>" class="btn btn-primary">Donasikan</a> 
