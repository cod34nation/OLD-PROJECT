    ...
    .panel
    {
        ...
        <div class="container">
            <div class="row">
              ...
              <form method ="POST" action ="prosesverifikasi.php">
      ...
      <div class="register-box-body">
        <p class="login-box-msg">Daftar Sebagai Member PANDA</p>
          ...
          <div class="form-group has-feedback">
            ...
            value ="<?php   // include "koneksi.php";
            $koneksi=mysql_connect('localhost','root','');
            mysql_select_db('panda',$koneksi); 
            $ad=$_SESSION['id_email'];
            $query= "SELECT * FROM email where id_email='$ad'";
      ...
      <br>
      <div class="form-group has-feedback">
      <select name="jenisdon" id="jenisdon" class="input">
