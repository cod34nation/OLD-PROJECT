...
$kueri="SELECT * FROM tujuan,konfirmasi where tujuan.id_tujuan=konfirmasi.id_tujuan group by konfirmasi.id_tujuan desc";
$cari=mysql_query($kueri);
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <br>
                 <center> <img class="profile-user-img img-responsive img-circle" src="images/Print-48.png" alt="User profile picture"></center>
              </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
