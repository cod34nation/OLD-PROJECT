<?php /* Smarty version Smarty-3.1.19, created on 2016-03-17 23:02:29
         compiled from "/opt/lampp/htdocs/prestashop/themes/default-bootstrap/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:98745774656eb2975cccad0-60517708%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87555200f6365e5d29d74a7b126540d962302b8e' => 
    array (
      0 => '/opt/lampp/htdocs/prestashop/themes/default-bootstrap/addresses.tpl',
      1 => 1452073828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '98745774656eb2975cccad0-60517708',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56eb2975e9cd55_09479886',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56eb2975e9cd55_09479886')) {function content_56eb2975e9cd55_09479886($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/htdocs/prestashop/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php $_tmp29=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp29), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
                <a class="btn btn-default button button-small" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
<?php $_tmp30=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp30."&delete"), ENT_QUOTES, 'UTF-8', true);?>
