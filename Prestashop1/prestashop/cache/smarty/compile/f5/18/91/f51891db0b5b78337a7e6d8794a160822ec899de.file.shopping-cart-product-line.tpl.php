<?php /* Smarty version Smarty-3.1.19, created on 2016-03-17 23:02:33
         compiled from "/opt/lampp/htdocs/prestashop/themes/default-bootstrap/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:98773066756eb297980da30-40123560%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f51891db0b5b78337a7e6d8794a160822ec899de' => 
    array (
      0 => '/opt/lampp/htdocs/prestashop/themes/default-bootstrap/shopping-cart-product-line.tpl',
      1 => 1452073828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '98773066756eb297980da30-40123560',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56eb297a615230_72272682',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56eb297a615230_72272682')) {function content_56eb297a615230_72272682($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/htdocs/prestashop/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/opt/lampp/htdocs/prestashop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp35=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']);?>
<?php $_tmp36=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php $_tmp37=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp35."&amp;ipa=".$_tmp36."&amp;id_address_delivery=".$_tmp37."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp40=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp38."&amp;ipa=".$_tmp39."&amp;id_address_delivery=".$_tmp40."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp43=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp41."&amp;ipa=".$_tmp42."&amp;id_address_delivery=".$_tmp43."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
