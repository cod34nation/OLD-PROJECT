<?php /* Smarty version Smarty-3.1.19, created on 2016-03-17 23:02:28
         compiled from "/opt/lampp/htdocs/prestashop/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:69977541456eb297435ddd9-94746009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acd6f6355fb33814baea8e89448b1b2e6d1c09c0' => 
    array (
      0 => '/opt/lampp/htdocs/prestashop/themes/default-bootstrap/history.tpl',
      1 => 1452073828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '69977541456eb297435ddd9-94746009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56eb29745d5463_61928067',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56eb29745d5463_61928067')) {function content_56eb29745d5463_61928067($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/opt/lampp/htdocs/prestashop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp16=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp16), ENT_QUOTES, 'UTF-8', true);?>
');">
...
, '<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp17=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp17), ENT_QUOTES, 'UTF-8', true);?>
');">
								<span>
...
<?php $_tmp18=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp18), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp19=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp19), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
